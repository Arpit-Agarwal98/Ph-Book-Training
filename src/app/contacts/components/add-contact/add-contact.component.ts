...
export class AddContactComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.contactForm = new FormGroup({
      ...
      name: new FormControl('Arpit', Validators.required), // Step 5: Work with Validators
      phone: new FormControl('4512659810', [Validators.required, Validators.maxLength(10)]), // Refer TS for step 6 // todo: max length 10
